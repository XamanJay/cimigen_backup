...
<div class="row homeView">
	...
	<div class="col-sm-10 col-md-10 noPad" style="z-index: 10;">
        ...
        <div class="sectionParto">
            <div class="row" style="margin: 0px;">
                <div class="col-xs-12 col-sm-6 col-md-7">
                    <h1 class="gineH1">Ginecología</h1>
                    <img src="img/ginecologia/logo.png" alt="Cimigen" class="img-responsive">
                    <h2>Precios:</h2>
                    <h1 class="gineH1">De acuerdo a estudio socioeconómico</h1>
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                    <form action="/contacto" method="POST" id="contactParto">
                        ...
                        <input class="form-control" type="hidden" name="titulo" id="titulo" value="Ginecologia">
		...
		<div class="row" id="partoInfo">
            ...
            <img src="img/ginecologia/banner.png" alt="Parto Humanizado" class="img-responsive" style="margin-top: 40px;">
            <p>Cuidamos la salud de las mujeres en edad reproductiva. Realizamos las siguientes cirugías:</p>
            <ul>
                <li>Histerectomía</li>
                <li>Miomectomía</li>
                <li>Tumores de ovario</li>
                <li>Ovario poliquístico</li>
                <li>Miomas (Tumores de la matríz)</li>
            </ul>
		</div>		
	</div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(object.type == "success") {
                    $(form)[0].reset();
                    grecaptcha.reset();
                    window.location.href = "/gracias_ginecologia";
                }
                else{
                    $("#response").html("");
