...
<div class="row homeView">
	...
	<div class="col-sm-10 col-md-10 noPad" style="z-index: 10;">
        ...
        <div class="sectionParto">
            <div class="row" style="margin: 0px;">
                <div class="col-xs-12 col-sm-6 col-md-7">
                    <h1>Estimulación Temprana</h1>
                    <img src="img/estimulacion_temprana/logo.png" alt="Cimigen" class="img-responsive">
                    <h2>Desde:</h2>
                    <h1>$180 <small>pesos</small></h1>
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                    <form action="/contacto" method="POST" id="contactParto">
                        ...
                        <input class="form-control" type="hidden" name="titulo" id="titulo" value="Estimulacion Temprana">
		...
		<div class="row" id="partoInfo">
            ...
            <img src="img/estimulacion_temprana/banner.png" alt="Parto Humanizado" class="img-responsive" style="margin-top: 40px;">
            <p>Te ofrecemos clases en las que aprenderás técnicas y actividades que podrás llevar a cabo con tu bebé para desarrollar al máximo sus capacidades cognitivas y motoras.</p>
            <p>Sábados:</p>
            <ul>
                <li>1 a 3 meses 13 y 27 de octubre 12:00</li>
                <li>4 a 6 meses 13 y 27 de octubre 9:00am</li>
                <li>7 a 10 meses 6 octubre 9:00am</li>
                <li>11 a 14 meses 4 de octubre 10:30am</li>
                <li>15 a 18 meses 13 octubre 10:30am</li>
                <li>19 a 23 meses 6 y 27 de octubre 10:30am</li>
                <li>24 a 36 meses 6 y 20 octubre 12:00pm</li>
            </ul>
		</div>		
	</div>
