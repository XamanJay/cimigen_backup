...
<div class="row homeView">
	...
	<div class="col-sm-10 col-md-10 noPad" style="z-index: 10;">
        ...
        <div class="sectionParto" id="colposcopiaBack">
            <div class="row" style="margin: 0px;">
                <div class="col-xs-12 col-sm-6 col-md-7">
                    <h1>Colposcopía</h1>
                    <img src="img/colposcopia/logo.png" alt="Cimigen" class="img-responsive">
                    <h2>Desde:</h2>
                    <h1>$350 <small>pesos</small></h1>
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                    <form action="/contacto" method="POST" id="contactParto">
                        ...
                        <input class="form-control" type="hidden" name="titulo" id="titulo" value="Colposcopia">
		...
		<div class="row" id="partoInfo">
            ...
            <img src="img/colposcopia/banner.png" alt="Ultrasonido Especializado" class="img-responsive" style="margin-top: 40px;">
            <p>Estudio directo del cuello uterino para detección del Virus del Papiloma Humano, riesgo de neoplasia y cáncer cérvico uterino. Este estudio, se realiza en una sola consulta por especialista en ginecología y obstetricia asi como:</p>
            <ul>
                <li><img src="img/atencion/arrow-colon.png" alt="Arrow"> Biopsia.</li>
                <li><img src="img/atencion/arrow-colon.png" alt="Arrow"> Criocirugía.</li>
                <li><img src="img/atencion/arrow-colon.png" alt="Arrow"> Papanicolaou.</li>
            </ul>
		</div>		
	</div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(object.type == "success") {
                    $(form)[0].reset();
                    grecaptcha.reset();
                    window.location.href = "/gracias_colposcopia";
                }
                else{
                    $("#response").html("");
