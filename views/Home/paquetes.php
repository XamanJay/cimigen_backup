...
<div class="row homeView">
	...
	<div class="col-sm-10 col-md-10 noPad" style="z-index: 10;">
		...
		<div class="sectionPaquetes">
			<div class="row" style="margin: 0px;">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<h2>Te acompañamos durante todo el embarazo y nacimiento de tu bebé</h2>
					<h3>Agenda tu consulta de filtro para recibir información acerca de nuestros paquetes, </h3>
					<h3>recuerda que estos son elaborados de acuerdo a un estudio socioeconómico</h3>
					<h3>que realiza nuestro equipo de trabajo social</h3>
					<h1>Nuestros Paquetes</h1>
					<img src="img/paquetes/logo.png" alt="Cimigen" class="img-responsive">
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
					<form action="/contacto" method="POST" id="contactParto">
                        ...
                        <input class="form-control" type="hidden" name="titulo" id="titulo" value="Parto Maternidad">
		...
		<div class="row" style="margin: 0px;margin-top: 80px;">
				<div class="col-xs-12 col-sm-8 col-md-8" id="paquetesItem">
					<div class="row" style="margin:0px;">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/prenatal.png" alt="" class="img-responsive">
							<ul>
								<li>5 Prenatales</li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/laboratorio.png" alt="" class="img-responsive">
							<ul>
								<li>1 Biometria hermática</li>
								<li>2 General de orina</li>
								<li>1 Glucosa</li>
								<li>1 Grupo sanguineo</li>
								<li>1 V.D.R.L</li>
								<li>1 V.I.H</li>
							</ul>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/parto.png" alt="" class="img-responsive">
							<ul>
								<li>1 Biometría hemática R/N</li>
								<li>1 Biometría hemática madre</li>
								<li>1 Grupo sanguíneo R/N</li>
							</ul>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/atencion.png" alt="" class="img-responsive">
							<ul>
								<li>Parto</li>
								<li>Medicamentos</li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/prevenir.png" alt="" class="img-responsive">
							<ul>
								<li>1 Papanicolaou</li>
								<li>1 Valoración nutricional</li>
								<li>1 Valoración dental</li>
								<li>5 Sesiones pdicoprofilaxis</li>
							</ul>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/postparto.png" alt="" class="img-responsive">
							<ul>
								<li>1 Revisión recien nacido</li>
								<li><span>Primer semana</span></li>
								<li>1 Revisión postparto</li>
								<li><span>Primer semana</span></li>
							</ul>
						</div>
						<!--div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/adicional.png" alt="" class="img-responsive">
							<ul>
								<li>1 Tamiz neonatal Hipotiroidismo</li>
								<li>4 Vacunas</li>
								<li>1 Antitetanica</li>
								<li>1 BCG</li>
								<li>Placas grupales</li>
								<li>(Programadas por atención para la salud y trabajo social)</li>
								<li>Nutrición</li>
								<li>Puericultura</li>
								<li>Lactancia al seno</li>
								<li>Estimulación temprana</li>
							</ul>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="img/paquetes/fondos.png" alt="" class="img-responsive">
							<ul>
								<li>Fondo de ambulancias  $30 pesos</li>
								<li>Ácido fólico   $25 pesos</li>
							</ul>
						</div-->
					</div>
				</div>
				<div class="col-xs-12 col-sm-1 col-md-1 hidden-xs">
					<img src="img/paquetes/line.png" alt="" class="img-responsive" id="linePaquetes">
				</div>
				<div class="col-xs-12 col-sm-3 col-md-2 noPadding hidden-xs">
					<p id="precios">Los precios pueden variar, consulte con nuestros asesores*</p>
				</div>
		</div>
		<a href="http://bit.ly/CMGSencillo" target="_blank" id="whatsPaquetes">
			<img src="img/whats_paquetes.png" alt="relleno">
		</a>
	</div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(object.type == "success") {
                    $(form)[0].reset();
                    grecaptcha.reset();
                    window.location.href = "/gracias_paquete_maternidad";
                }
                else{
                    $("#response").html("");
