...
<div class="row homeView">
	...
	<div class="col-sm-10 col-md-10 noPad" style="z-index: 10;">
        ...
        <div class="sectionParto">
            <div class="row" style="margin: 0px;">
                <div class="col-xs-12 col-sm-6 col-md-7">
                    <h1>Pediatría</h1>
                    <img src="img/pediatria/logo.png" alt="Cimigen" class="img-responsive">
                    <h2>Precios:</h2>
                    <h1>Consulta Pediátrica $250 <small>pesos</small></h1>
                    <h1>Neurodesarrollo $200 <small>pesos</small></h1>
                    <h1>Seguimiento Longitudinal $200 <small>pesos</small></h1>
		...
		<div class="row" id="partoInfo">
            ...
            <img src="img/pediatria/banner.png" alt="Parto Humanizado" class="img-responsive" style="margin-top: 40px;">
            <p>Contamos con el programa "Control del Niño Sano", mediante el cual supervisamos, desde su nacimiento, el estado de salud, crecimiento y desarrollo de nuestros pacientes, además de la detección precoz y tratamiento de problemas de salud a través de un equipo multidisciplinario.</p>
		</div>		
	</div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(object.type == "success") {
                    $(form)[0].reset();
                    grecaptcha.reset();
                    window.location.href = "/gracias_pediatria";
                }
                else{
                    $("#response").html("");
